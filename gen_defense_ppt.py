...
add_text(s, 7.2, 2.6, 5.0, 3.4,
         [([('RAG 攻坚：', 12, True, DARK), ('检索效果不达预期 → 自主查阅官方文档、开源社区与论文，系统对比多种方案 → 攻克并沉淀检索优化方法论', 12, False, DARK)], PP_ALIGN.LEFT, 6, 1.25),
          ([('Neo4j 攻坚：', 12, True, DARK), ('实体关系建模遇阻 → 查阅官方文档与社区实践 → 独立完成 Schema 设计与多跳查询优化', 12, False, DARK)], PP_ALIGN.LEFT, 6, 1.25),
          ([('帮扶来源：', 12, True, ORANGE), ('课程与三项实训打底 + 开源社区/官方文档 + 指导教师方向把关（学生独立完成）', 12, False, DARK)], PP_ALIGN.LEFT, 0, 1.25)])
...
# ================= P32 专家顾问 =================
s = new_slide()
header(s, '团队（3/4）：专家顾问对接计划', 32)
tag(s, 11.9, 1.15, '计划')
advs = [
    ('行业顾问', '计划通过创新创业学院引荐\n教育信息化行业专家\n2026.12 前完成对接', BLUE),
    ('商业顾问', '计划通过创业辅导体系对接\nSaaS 商业模式与融资专家\n2026.12 前完成对接', ORANGE),
    ('学术技术顾问', '计划依托课程教师推荐\nNLP / 知识图谱方向\n2026.12 前完成对接', MIDBLUE),
]
...
add_text(s, 0.9, 5.4, 11.5, 1.2,
         [([('当前真实支撑：开源社区与官方文档（RAG/Neo4j 自学攻坚）· 课程与三项实训 · 创新创业学院辅导', 12, True, DARK)], PP_ALIGN.CENTER, 2, 1.25),
          ([('说明：顾问按评审要求不放本校教师，正在对接中；指导教师陈圣波见下一页"学校给予项目的支撑"', 11.5, False, GRAY)], PP_ALIGN.CENTER, 0, 1.25)])
